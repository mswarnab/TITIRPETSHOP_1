  ...
  return (
    <Grid container rowSpacing={4.5} columnSpacing={2.75}>    
      ...
      <Grid item xs={12} md={12} lg={12}>
        ...
        <Typography variant='h4' style={{marginBottom:10}}>Create New Purchase Order</Typography>
        <div>
        {/* <TextField
            autoFocus
            required
          ...
          />
            ...
            variant="standard"
          />
            <span style={{position:"relative",top:17,fontSize:12,color:'rgb(22, 119, 255)'}}>Date of Purchase</span>
                  <TextField
            autoFocus
            required
            margin="normal"
