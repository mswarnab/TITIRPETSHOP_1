  ...
  return (
    <Grid container rowSpacing={4.5} columnSpacing={2.75}>    
      ...
      <Grid item xs={12} md={12} lg={12}>
        ...
        <Typography variant='h4' style={{marginBottom:10}}>Create New Selling Bill</Typography>
        <div>
        <TextField
            autoFocus
            required
        ...
        <Button variant='contained' color='secondary' style={{width:'100%',marginTop:"30px"}}>Add Items</Button>
        </MainCard>
      </Grid>
    </Grid>
  );
